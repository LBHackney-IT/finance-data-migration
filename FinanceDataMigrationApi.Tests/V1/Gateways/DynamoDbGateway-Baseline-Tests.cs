...
using AutoFixture;
using FinanceDataMigrationApi.Tests.V1.Helper;
...
namespace FinanceDataMigrationApi.Tests.V1.Gateways
{
    ...
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-finance-data-migration-api/wiki/Running-the-test-suite.
    [TestFixture]
