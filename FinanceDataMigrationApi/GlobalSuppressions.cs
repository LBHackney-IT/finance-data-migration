...
[assembly: SuppressMessage("Design", "CA1031:Do not catch general exception types", Justification = "<Pending>", Scope = "member", Target = "~M:FinanceDataMigrationApi.Handler.DownloadAssetToIfs(System.Int32)~System.Threading.Tasks.Task{FinanceDataMigrationApi.V1.Boundary.Response.StepResponse}")]
[assembly: SuppressMessage("Design", "CA1031:Do not catch general exception types", Justification = "<Pending>", Scope = "member", Target = "~M:FinanceDataMigrationApi.Handler.DownloadAssetToIfs~System.Threading.Tasks.Task{FinanceDataMigrationApi.V1.Boundary.Response.StepResponse}")]
