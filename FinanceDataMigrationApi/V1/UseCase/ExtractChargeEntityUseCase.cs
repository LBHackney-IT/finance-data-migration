...
namespace FinanceDataMigrationApi.V1.UseCase
{
    public class ExtractChargeEntityUseCase : IExtractChargeEntityUseCase
    {
        ...
        {
            string step = "ExtractChargeEntityUseCase.ExecuteAsync";
            try
            {
                ...
                step += "/GetDMRunLogByEntityNameAsync";
                ...
                step += "/_dMRunLogGateway.AddAsync";
                ...
                step += "/_dMChargeGateway.ExtractAsync";
                ...
                step += "/dMRunLogGateway.UpdateAsync";
