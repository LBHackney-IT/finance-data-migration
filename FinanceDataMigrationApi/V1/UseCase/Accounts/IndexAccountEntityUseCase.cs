...
namespace FinanceDataMigrationApi.V1.UseCase.Accounts
{
    ...
    {
        private readonly IEsGateway<QueryableAccount> _esGateway;
        ...
        public IndexAccountEntityUseCase(IEsGateway<QueryableAccount> esGateway, IDMRunLogGateway dMRunLogGateway, IAccountsGateway accountsGateway)
        {
